...
var CustomImportScript = (() => {
  ...
  var import_programme_landing_exports = {};
  __export(import_programme_landing_exports, {
    default: () => import_programme_landing_default
  });
  ...
  var import_programme_landing_default = {
    transform: (payload) => {
      const {
        document,
        url,
  ...
  return __toCommonJS(import_programme_landing_exports);
})();
